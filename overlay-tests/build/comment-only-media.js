 ...
 */
export const createSilentTimeline = (durationSeconds) => {
...
export const resolveCommentTimelineDuration = (comments, tailSeconds = 10) => {
...
//# sourceMappingURL=comment-only-media.js.map