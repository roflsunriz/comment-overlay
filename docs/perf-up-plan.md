...
`improve-performance.md` の分析に基づき、実装の難易度とリグレッションリスクが低いものから順に並べた実行計画。
...
2.  **[文字幅計測 (`ctx.measureText`) のキャッシュ]**
...
5.  **[`Array.prototype.sort` の呼び出し回数削減]**
