...
export const COLLISION_BUFFER_RATIO = 0.35;
export const BASE_COLLISION_BUFFER_PX = 48;
export const ENTRY_BUFFER_PX = 48;
export const RESERVATION_TIME_MARGIN_MS = 0;
...
export const STATIC_VISIBLE_DURATION_MS = 3_000;
...
export const NICO_SCROLL_VPOS_LEAD_MS = 1_800;
...
export const NICO_FULL_SCROLL_VPOS_LEAD_MS = 2_300;
