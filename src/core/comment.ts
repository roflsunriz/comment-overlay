...
import { createDefaultTimeSource, type TimeSource } from "./comment/time-source";
import type { CommentDependencies, CommentPrepareOptions } from "./comment/types";
import { prepareComment } from "./comment/helpers/prepare";
import { drawComment } from "./comment/helpers/render";
